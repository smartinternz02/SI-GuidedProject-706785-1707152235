...
WebUI.setText(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/input_email'), 'ananya.annikutti@gmail.com')

WebUI.click(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Amazon_Sign In_OR/Page_Amazon Sign-In/input_password'), '2E5ui8+TMvX+rRf2OIDVAQ==')
